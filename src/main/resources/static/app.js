...
const guideKnowledge = {
    "Автозагар": guideKnowledgeItem(
        "Ровный оттенок без оранжевого лица, пятен у волос и тёмных ладоней.",
        ["За сутки мягко отшелуши только шелушащиеся зоны и увлажни их.", "Сделай пробу оттенка на незаметном участке и оцени цвет через 24 часа.", "На лицо наноси остаток средства с перчатки или отдельную лёгкую формулу.", "Растушуй линию роста волос, брови, уши и переход к шее."],
        ["Наносить плотный слой на сухую кожу.", "Использовать средство для тела вокруг глаз.", "Оценивать цвет сразу после нанесения, пока он ещё проявляется."],
        "Фото у окна через 24 часа: оттенок ровный, шея не отличается от лица, поры не подчеркнуты.",
        "При жжении, сыпи или отёке смой средство и прекрати использование."
    ),
    "Акне": guideKnowledgeItem(
        "Спокойная система ухода, которая не усиливает воспаление и позволяет оценить реальный эффект.",
        ["Определи тип высыпаний и сделай фото при одинаковом свете.", "Оставь мягкое очищение, некомедогенное увлажнение и SPF.", "Выбери только один актив по рекомендации врача или инструкции и дай ему 6–8 недель.", "Отмечай новые воспаления, болезненность и реакцию барьера раз в неделю."],
        ["Выдавливать воспаления и тереть лицо скрабом.", "Менять лечение каждые несколько дней.", "Подсушивать кожу спиртом и одновременно убирать увлажнение."],
        "Сравни количество новых воспалений и болезненность через 6–8 недель, а не отдельный удачный день.",
        "Глубокие болезненные узлы, рубцы или стойкое ухудшение — повод обратиться к дерматологу."
    ),
    "Акнекутан: что важно знать": guideKnowledgeItem(
        "Понять, как безопасно проходить назначенный врачом курс изотретиноина без самодеятельности.",
        ["Принимай препарат только под наблюдением дерматолога и соблюдай назначенный контроль.", "Собери мягкий уход: деликатное очищение, увлажнение, бальзам для губ и SPF.", "Записывай сухость, изменения зрения, боли в мышцах и другие новые симптомы.", "Согласовывай с врачом лекарства, добавки и косметологические процедуры."],
        ["Самостоятельно менять дозировку или делиться препаратом.", "Добавлять витамин A, ретиноиды, кислоты и жёсткие пилинги без согласования.", "Игнорировать требования по предотвращению беременности и мониторингу."],
        "Курс контролируется врачом; косметическая цель вторична по отношению к безопасности и переносимости.",
        "Беременность во время курса недопустима; при тяжёлых или необычных симптомах нужно срочно связаться с врачом."
    ),
    "Диета и кожа": guideKnowledgeItem(
        "Найти личные пищевые триггеры без запретов, дефицитов и псевдонаучных списков.",
        ["Две недели фиксируй рацион, сон, цикл, стресс и новые воспаления.", "Меняй только одну гипотезу за раз, сохраняя белок, клетчатку и общую калорийность.", "Сравнивай недельные тренды кожи, а не реакцию на один продукт.", "Возвращай исключённый продукт контролируемо, чтобы проверить связь."],
        ["Убирать сразу молочное, глютен, сахар и жиры.", "Компенсировать дефицит калорий случайными добавками.", "Приписывать еде высыпания, совпавшие со стрессом или сменой ухода."],
        "Рабочий вывод — воспроизводимая реакция после исключения и повторного введения, а не ощущение.",
        "При выраженных ограничениях, расстройствах пищевого поведения или заболеваниях ЖКТ нужен врач или диетолог."
    ),
    "SPF без жирного блеска": guideKnowledgeItem(
        "Надёжная защита, которая комфортно лежит на коже и не провоцирует отказ от ежедневного нанесения.",
        ["Ищи широкий спектр защиты SPF 30+ и текстуру под свой тип кожи.", "Наноси после ухода равномерным слоем, не растирая бесконечно.", "Дай слоям осесть перед макияжем или выходом.", "Обновляй защиту при длительном пребывании на солнце, поте или воде."],
        ["Смешивать SPF с кремом в ладони.", "Оставлять без защиты уши, шею и линию роста волос.", "Выбирать матовость ценой стянутости и раздражения."],
        "Через час кожа комфортна, средство не скатывается и ты готов наносить его каждый день.",
        "Если щиплет вокруг глаз или появляется сыпь, смени формулу, а не отказывайся от защиты."
    ),
    "Постакне и тон": guideKnowledgeItem(
        "Отделить пятна от рубцов и выбрать реалистичный путь выравнивания тона.",
        ["Сфотографируй кожу прямо и сбоку: рельефные тени указывают на изменение текстуры.", "Сначала останови новые воспаления и стабилизируй барьер.", "Ежедневно используй SPF и вводи только один осветляющий актив.", "Для выраженного рельефа собери консультацию по процедурам у дерматолога."],
        ["Шлифовать активное акне домашними пилингами.", "Одновременно вводить кислоты, ретиноид и витамин C.", "Считать любой красный след глубоким рубцом."],
        "Пятна оцениваются по фото раз в четыре недели; рельеф — только при одинаковом боковом свете.",
        "Быстро растущая пигментация, кровоточивость или нетипичные образования требуют очной оценки."
    ),
    "Очищение без скрипа": guideKnowledgeItem(
        "Снять SPF, пот и загрязнения, не разрушая защитный барьер кожи.",
        ["Используй тёплую, не горячую воду.", "Массируй мягкое средство 30–40 секунд без щёток.", "После стойкого SPF при необходимости добавь отдельный первый этап очищения.", "Оцени кожу через 10 минут без крема: стянутости быть не должно."],
        ["Мыть лицо до ощущения скрипа.", "Умываться агрессивным средством после каждого прикосновения к коже.", "Компенсировать жирность частыми спиртовыми лосьонами."],
        "После умывания нет жжения, красноты и желания немедленно нанести плотный крем.",
        "Стойкое шелушение, зуд или трещины — сигнал упростить уход и обсудить состояние с дерматологом."
    ),
    "Увлажнение": guideKnowledgeItem(
        "Поддержать барьер так, чтобы кожа была эластичной, но не перегруженной.",
        ["Наноси крем на слегка влажную кожу.", "Для обезвоженности ищи увлажнители, для сухости — липиды и более плотную текстуру.", "Утром проверяй совместимость крема с SPF.", "Меняй плотность по сезону, а не всю рутину сразу."],
        ["Считать жирную кожу автоматически хорошо увлажнённой.", "Наслаивать несколько сывороток с одинаковой функцией.", "Продолжать средство, которое стабильно щиплет."],
        "К вечеру нет стянутости, а SPF и макияж не собираются на шелушениях.",
        "Отёк, крапивница или выраженное жжение требуют отмены нового средства."
    ),
    "Ретиноиды: старт": guideKnowledgeItem(
        "Ввести ретиноид постепенно и получить эффект без хронического раздражения.",
        ["Уточни противопоказания и выбери подходящую форму с врачом или фармацевтом.", "Начинай редко: небольшое количество вечером на сухую кожу.", "Поддерживай барьер кремом и используй SPF днём.", "Увеличивай частоту только когда нет стойкого жжения и шелушения."],
        ["Наносить больше ради быстрого результата.", "В тот же вечер добавлять кислоты и скрабы.", "Начинать перед отпуском на солнце или важным событием."],
        "Через 8–12 недель сравни тон, текстуру и переносимость по одинаковым фото.",
        "Ретиноиды противопоказаны при беременности; сильное воспаление и отёк требуют отмены и консультации."
    ),
    "Кислоты": guideKnowledgeItem(
        "Выбрать кислоту под конкретную задачу и не превратить отшелушивание в раздражение.",
        ["BHA чаще выбирают для пор и жирности, AHA — для поверхности и тона.", "Начни с одного средства один раз в неделю.", "Не сочетай в один вечер с другим раздражающим активом.", "На следующий день оцени жжение, красноту и сухость."],
        ["Покупать максимальную концентрацию.", "Использовать кислотный тоник как обязательный ежедневный этап.", "Наносить на повреждённую или обгоревшую кожу."],
        "Через месяц кожа ровнее без постоянной красноты и компенсаторного шелушения.",
        "Сильная боль, пузыри или мокнутие похожи на ожог и требуют прекращения использования."
    ),
    "Бритьё и раздражение": guideKnowledgeItem(
        "Чистое бритьё без порезов, вросших волос и красной нижней трети лица.",
        ["Размягчи волос тёплой водой и используй скользящий гель.", "Первый проход делай по росту волос короткими движениями.", "Не нажимай и регулярно меняй лезвие.", "После бритья нанеси простой успокаивающий крем без спирта."],
        ["Сбривать одну зону много раз насухо.", "Проводить против роста при склонности к вросшим волосам.", "Хранить влажную бритву без просушки."],
        "Через сутки нет новых болезненных бугорков, а покраснение проходит в течение часа.",
        "Гнойные элементы, болезненные узлы или рубцевание лучше показать дерматологу."
    ),
    "Отёки утром": guideKnowledgeItem(
        "Отличить обычную утреннюю задержку жидкости от устойчивого симптома.",
        ["Сделай недельную таблицу сна, соли, алкоголя, аллергии и времени последнего приёма пищи.", "Фотографируй лицо через одинаковое время после пробуждения.", "Проверь регулярность сна и достаточность воды в течение дня.", "Сравни обе стороны лица и длительность отёка."],
        ["Пытаться «сушиться» и резко ограничивать воду.", "Массировать болезненную или воспалённую область.", "Списывать постоянный односторонний отёк на недосып."],
        "Полезный маркер — время, за которое отёк спадает, и связь с повторяемыми факторами.",
        "Внезапный, односторонний отёк, одышка или отёк губ требуют срочной медицинской помощи."
    ),
    "Губы и барьер": guideKnowledgeItem(
        "Вернуть губам гладкость и убрать цикл «облизал — стало суше».",
        ["На неделю убери ароматизированные бальзамы и скрабы.", "Используй простое окклюзивное средство несколько раз в день.", "Днём добавь защиту от солнца.", "На ночь наноси более плотный слой, особенно в сухом помещении."],
        ["Отрывать шелушения и кусать губы.", "Использовать ментол, корицу и ароматизаторы при раздражении.", "Лечить трещины постоянным кислотным пилингом."],
        "Через 7 дней меньше трещин, жжения и потребности постоянно облизывать губы.",
        "Трещины в углах рта, пузырьки или отсутствие улучшения требуют диагностики."
    ),
    "Минимальная рутина": guideKnowledgeItem(
        "Три понятных шага, которые можно стабильно выполнять и безопасно расширять.",
        ["Утро: вода или мягкое очищение, увлажнение по потребности, SPF.", "Вечер: снять SPF и загрязнения, затем нанести крем.", "Две недели не добавляй активы и оцени базовую реакцию.", "После стабилизации добавляй одно средство под одну задачу."],
        ["Собирать рутину из трендов, а не потребностей кожи.", "Менять несколько продуктов одновременно.", "Считать сложность признаком эффективности."],
        "Рутина занимает меньше пяти минут, не раздражает кожу и выполняется почти ежедневно.",
        "Если базовые средства вызывают стойкую реакцию, стоит искать аллерген вместе со специалистом."
    ),
    "Форма стрижки": guideKnowledgeItem(
        "Стрижка, которая поддерживает пропорции лица и естественное направление волос.",
        ["Сними анфас, профиль и затылок без укладки.", "Отметь ширину висков, высоту лба и объём в затылке.", "Выбери референс с похожей густотой и линией роста.", "Попроси мастера объяснить, где останется вес и как форма будет отрастать."],
        ["Копировать стрижку с другой структурой волос.", "Убирать весь вес по бокам при вытянутом лице.", "Оценивать форму только сразу после салонной укладки."],
        "Через две недели волосы сами ложатся в задуманный силуэт за 5–7 минут.",
        "При заметном выпадении или воспалении кожи головы сначала нужен дерматолог."
    ),
    "Виски и затылок": guideKnowledgeItem(
        "Чистый контур, который выглядит естественно и аккуратно отрастает.",
        ["Выбери мягкий taper, средний переход или плотный контур под свой стиль.", "Проверь переход за ушами и отсутствие тёмной ступени на затылке.", "Не поднимай естественную линию шеи слишком высоко.", "Запланируй коррекцию по скорости отрастания, обычно раньше полной стрижки."],
        ["Делать слишком высокий фейд без учёта формы головы.", "Выбривать острые линии там, где рост редкий.", "Маскировать ступени большим количеством продукта."],
        "Контур выглядит чисто анфас, сбоку и сзади даже без укладки.",
        "Раздражение после машинки требует чистого инструмента и более щадящей длины."
    ),
    "Объём сверху": guideKnowledgeItem(
        "Поднять корни и сохранить движение волос без тяжёлой шапки.",
        ["Нанеси лёгкий престайлер на влажные волосы.", "Суши корни против привычного направления, направляя поток от корней к концам.", "Форму фиксируй прохладным воздухом.", "Финишный продукт наноси малыми порциями на середину и концы."],
        ["Наносить воск на мокрые корни.", "Перегревать одну зону феном.", "Начёсывать волосы до спутывания."],
        "Объём держится минимум половину дня и остаётся подвижным при прикосновении.",
        "Ломкость и жжение кожи головы — повод снизить температуру и пересмотреть средства."
    ),
    "Укладка без грязного блеска": guideKnowledgeItem(
        "Текстура и фиксация без склеенных прядей и эффекта несвежих волос.",
        ["Начни с полностью высушенной формы.", "Разотри горошину матовой пасты до прозрачности.", "Вводи продукт с затылка, остатком прорабатывая передние пряди.", "Добавляй средство только после оценки при дневном свете."],
        ["Сразу брать большую порцию.", "Наносить продукт только на чёлку.", "Смешивать несколько жирных средств без необходимости."],
        "Пряди разделены, кожа головы не блестит, а пальцы не остаются липкими.",
        "Зуд и шелушение после продукта означают, что его нужно смыть и заменить."
    ),
    "Подбор мастера": guideKnowledgeItem(
        "Найти специалиста, который умеет работать с твоей структурой волос и объясняет решения.",
        ["Смотри портфолио без фильтров и с похожими исходными данными.", "Перед записью уточни опыт с нужной длиной и текстурой.", "На консультации проговори время на укладку и частоту коррекции.", "Попроси показать форму с разных сторон до финальной укладки."],
        ["Выбирать только по интерьеру и числу подписчиков.", "Приносить один референс без объяснения, что именно нравится.", "Молчать, если переход или длина не устраивают."],
        "После визита ты понимаешь, как уложить волосы дома и когда обновлять форму.",
        "Грязные инструменты и игнорирование кожных проблем — причина сменить специалиста."
    ),
    "Борода и щетина": guideKnowledgeItem(
        "Контур бороды, который усиливает нижнюю треть лица, а не рисует чужую челюсть.",
        ["Оцени плотность на щеках, подбородке и усах при длине 3–5 мм.", "Выбери одну равномерную базовую длину.", "Сформируй естественную линию щёк без чрезмерного занижения.", "Переход на шее делай мягким и проверяй профиль."],
        ["Рисовать слишком высокую линию шеи.", "Отращивать редкие участки значительно длиннее плотных.", "Использовать краситель темнее волос и бровей."],
        "Анфас контур симметричен, в профиль не появляется тяжёлый «фартук».",
        "Болезненные вросшие волосы и стойкое воспаление лучше обсудить с дерматологом."
    ),
    "Линия роста": guideKnowledgeItem(
        "Отличить особенности линии роста от прогрессирующего поредения и вовремя собрать данные.",
        ["Сделай серию фото висков и пробора при одном свете и фокусе.", "Повторяй фото раз в месяц, не ежедневно.", "Отмечай усиленное выпадение, зуд и семейную историю.", "При изменениях обратись к дерматологу или трихологу для диагностики."],
        ["Сравнивать мокрые и сухие волосы.", "Начинать лекарства и добавки без диагноза.", "Маскировать проблему агрессивной натяжной укладкой."],
        "Вывод делают по серии сопоставимых фото за несколько месяцев, а не по одному ракурсу.",
        "Резкое очаговое выпадение, рубцевание или воспаление требуют быстрой очной оценки."
    ),
    "Сушка волос": guideKnowledgeItem(
        "Быстро сформировать направление волос с меньшим перегревом и пушением.",
        ["Промокни волосы полотенцем без растирания.", "Нанеси термозащиту и расчеши в нужном направлении.", "Держи фен на расстоянии и постоянно перемещай поток.", "Сначала собери форму, затем зафиксируй прохладным воздухом."],
        ["Сушить на максимуме одну точку.", "Тереть мокрые волосы грубым полотенцем.", "Пытаться создать форму после полного высыхания."],
        "Волосы гладкие у кутикулы, держат направление и не пахнут перегревом.",
        "Ломкость и раздражение кожи головы требуют более низкой температуры."
    ),
    "Референсы для барбера": guideKnowledgeItem(
        "Собрать понятное техническое задание вместо фразы «сделайте как на фото».",
        ["Выбери 3–4 фото с похожей густотой и текстурой.", "Отдельно отметь желаемые виски, верх, затылок и чёлку.", "Добавь фото того, что точно не нравится.", "Обсуди, как референс изменится под линию роста и форму головы."],
        ["Приносить изображение с фильтром или париком.", "Показывать только фронтальный ракурс.", "Требовать точную копию без учёта ежедневной укладки."],
        "Мастер может повторить твою задачу своими словами до начала работы.",
        "Если специалист обещает невозможную плотность или не объясняет адаптацию, лучше взять паузу."
    ),
    "Форма бровей": guideKnowledgeItem(
        "Естественная рамка взгляда без тонкой дуги и жёсткого графичного начала.",
        ["Расчеши волоски вверх и сфотографируй лицо прямо.", "Убери только явно выбивающиеся волоски между бровями и под хвостом.", "Сохрани природную толщину у начала.", "Проверяй форму на расстоянии, а не в увеличивающем зеркале."],
        ["Строить обе брови по одному трафарету.", "Сильно поднимать арку.", "Укорачивать хвост до потери баланса."],
        "Взгляд открыт, но брови не выглядят нарисованными отдельно от лица.",
        "Стойкое покраснение после коррекции требует более щадящего метода."
    ),
    "Плотность": guideKnowledgeItem(
        "Визуально заполнить редкие участки, сохранив текстуру настоящих волосков.",
        ["Определи пробелы при дневном свете.", "Заполняй их тонкими штрихами по росту волос.", "Начало оставляй легче хвоста.", "Закрепляй прозрачным или слегка тонированным гелем."],
        ["Закрашивать всю бровь одним блоком.", "Выбирать оттенок значительно темнее корней волос.", "Компенсировать редкость чрезмерной шириной."],
        "С расстояния вытянутой руки видна форма, а отдельные штрихи не считываются.",
        "Быстрое поредение бровей вместе с другими симптомами стоит обсудить с врачом."
    ),
    "Симметрия": guideKnowledgeItem(
        "Сделать брови визуально согласованными, не стирая естественную асимметрию лица.",
        ["Сравни высоту начала, арки и хвоста на фото, а не в зеркале.", "Корректируй сначала укладкой, затем минимальным заполнением.", "Работай попеременно по несколько штрихов.", "Остановись, когда разница перестала отвлекать в общем портрете."],
        ["Перещипывать более низкую бровь.", "Измерять миллиметры при разной мимике.", "Дорисовывать арку выше естественного роста."],
        "Обе брови имеют похожий визуальный вес, хотя не обязаны быть зеркальными.",
        "Внезапное опущение одной стороны лица требует срочной медицинской оценки."
    ),
    "Цвет и контраст": guideKnowledgeItem(
        "Подобрать оттенок бровей, который усиливает глаза и не делает выражение суровым.",
        ["Сравни оттенок с корнями волос при дневном свете.", "Для светлых волос пробуй нейтральный taupe, для тёмных — на тон мягче волос.", "Начало заполняй минимально.", "Оцени результат рядом с цветом кожи и глаз."],
        ["Использовать чисто чёрный при мягком природном контрасте.", "Красить кожу плотнее, чем волоски.", "Игнорировать слишком тёплый или пепельный подтон."],
        "Брови читаются, но остаются вторичными по отношению к глазам.",
        "Аллергическую пробу краски делай по инструкции; при отёке немедленно смой."
    ),
    "Укладка": guideKnowledgeItem(
        "Зафиксировать направление волосков без ламинированной корки.",
        ["Очисти брови от крема и SPF.", "Набери минимум геля и сними излишки с щётки.", "Уложи начало вверх, середину по диагонали, хвост в сторону.", "Прижми выбивающиеся волоски чистой щёткой."],
        ["Наслаивать гель до белых хлопьев.", "Зачёсывать весь хвост строго вверх.", "Использовать сильную фиксацию на раздражённой коже."],
        "Волоски держат направление, но остаются различимыми и подвижными.",
        "Зуд, выпадение или ломкость после фиксатора — повод прекратить его использование."
    ),
    "Ошибки коррекции": guideKnowledgeItem(
        "Восстановить форму после перещипывания и перестать повторять одну и ту же ошибку.",
        ["На 6–8 недель убери пинцет, кроме зоны между бровями.", "Раз в две недели фотографируй рост при одном свете.", "Временно заполняй пробелы тонкими штрихами.", "После отрастания задай нижнюю линию минимальной коррекцией."],
        ["Каждый день выравнивать появляющиеся волоски.", "Сбривать хвост, чтобы нарисовать новый.", "Использовать агрессивные стимуляторы без понимания причины редкости."],
        "Контур становится плотнее, а необходимость дорисовывать уменьшается.",
        "Если волоски не возвращаются или выпадают очагами, нужна консультация специалиста."
    ),
    "Брови и взгляд": guideKnowledgeItem(
        "Настроить направление и вес бровей под желаемое выражение лица.",
        ["Для более открытого взгляда подними начало мягко, не создавая удивлённую арку.", "Для спокойного выражения смягчи резкий излом.", "Сохрани хвост достаточно длинным для баланса глаза.", "Проверь результат с нейтральной мимикой и улыбкой."],
        ["Оценивать брови только крупным планом.", "Делать резкое квадратное начало.", "Компенсировать нависшее веко слишком высокой аркой."],
        "На портретном фото взгляд читается яснее, но форма бровей не перетягивает внимание.",
        "Любая коррекция должна учитывать подвижность мимики, а не только статичную разметку."
    ),
    "Мини-протокол": guideKnowledgeItem(
        "Пятиминутный порядок действий для аккуратных бровей без салонной перегрузки.",
        ["Расчеши и оцени форму целиком.", "Убери 3–5 очевидно лишних волосков.", "Заполни только пробелы.", "Уложи гелем и проверь результат при обычном расстоянии."],
        ["Начинать с пинцета до расчёсывания.", "Корректировать обе брови по очереди целиком.", "Добавлять продукт там, где уже достаточно плотности."],
        "Вся процедура укладывается в пять минут и не меняет природную форму.",
        "Если кожа повреждена или воспалена, отложи коррекцию до восстановления."
    ),
    "Силуэт": guideKnowledgeItem(
        "Собрать пропорции одежды так, чтобы лицо, плечи и рост считывались цельно.",
        ["Сделай фото анфас и сбоку в базовом комплекте.", "Отметь линию плеч, талии и длину верха.", "Меняй только один параметр: объём, длину или посадку.", "Повтори фото с расстояния на уровне груди."],
        ["Покупать вещь только из-за тренда.", "Скрывать фигуру одинаковым объёмом сверху и снизу.", "Оценивать посадку только перед зеркалом сверху вниз."],
        "На фото видна понятная вертикаль и один главный объём, а одежда не перетягивает фигуру.",
        "Комфорт движения и дыхания важнее визуально более узкой посадки."
    ),
    "Цвета у лица": guideKnowledgeItem(
        "Найти оттенки, которые делают кожу визуально ровнее, а глаза — выразительнее.",
        ["При дневном свете приложи к лицу холодный и тёплый варианты одного цвета.", "Смотри на тени под глазами, красноту и контраст глаз.", "Собери три выигрышных нейтрали и два акцента.", "Проверяй цвет без фильтра и рядом с фактическим оттенком волос."],
        ["Определять палитру по цвету вен.", "Покупать сложный оттенок без примерки у лица.", "Смешивать много конкурирующих акцентов."],
        "В удачном цвете лицо замечают раньше одежды, а тон выглядит спокойнее.",
        "Палитра — инструмент, а не запрет: любимый цвет можно отнести ниже от лица."
    ),
    "Капсула на 30 дней": guideKnowledgeItem(
        "Небольшой набор вещей, из которого собираются готовые комплекты без утренней лотереи.",
        ["Выбери два сценария жизни, которые покрывают большинство дней.", "Собери базу из совместимых верхов, низов и двух пар обуви.", "Сфотографируй минимум десять готовых комплектов.", "Добавляй новую вещь только если она работает хотя бы в трёх образах."],
        ["Строить капсулу вокруг редких событий.", "Покупать одинаковые по функции вещи.", "Игнорировать верхнюю одежду, сумку и обувь."],
        "За пять минут можно выбрать комплект, и большинство вещей носится каждую неделю.",
        "Не покупай капсулу целиком за один день: сначала протестируй имеющиеся связки."
    ),
    "Шея вперёд": guideKnowledgeItem(
        "Уменьшить привычное выдвижение головы и вернуть нейтральное положение без силового запрокидывания.",
        ["Сними профиль в расслабленной стойке.", "Подними экран до уровня глаз и сократи длительные наклоны.", "Практикуй мягкое втягивание подбородка без боли.", "Добавь движение грудного отдела и регулярные перерывы."],
        ["Тянуть голову назад силой.", "Делать упражнения через головокружение или прострел.", "Пытаться держать идеальную позу весь день без смены положения."],
        "На профиле ухо ближе к линии плеча, а поза не требует постоянного напряжения.",
        "Онемение, слабость, сильная боль или травма требуют оценки врача или физиотерапевта."
    ),
    "Плечи": guideKnowledgeItem(
        "Сделать линию плеч более открытой и симметричной через подвижность и контроль.",
        ["Проверь высоту плеч на фото без намеренной коррекции.", "Разомни грудные мышцы и добавь тяговые движения.", "Следи, чтобы рёбра не выпячивались при «раскрытии».", "Меняй сторону сумки и положение рабочего места."],
        ["Сводить лопатки максимально сильно весь день.", "Игнорировать разницу подвижности рук.", "Тренировать только переднюю дельту и грудь."],
        "Руки свободно висят, плечи не поднимаются к ушам, одежда лежит ровнее.",
        "Боль, ограничение движения или выраженная асимметрия требуют специалиста."
    ),
    "Лопатки": guideKnowledgeItem(
        "Научить лопатки двигаться вместе с руками и улучшить контроль верхней части спины.",
        ["Сними движение рук спереди и сзади.", "Начни с скольжений по стене и лёгких тяг.", "Контролируй плавное движение без пожимания плечами.", "Увеличивай нагрузку только при стабильной технике."],
        ["Насильно прижимать лопатки к позвоночнику.", "Работать с большим весом при потере контроля.", "Диагностировать «крыловидность» по одному фото."],
        "Подъём рук становится плавнее, а шея меньше включается в каждое движение.",
        "Выраженное выпирание, слабость руки или неврологические симптомы нужно оценить очно."
    ),
    "Таз и поясница": guideKnowledgeItem(
        "Найти устойчивое положение таза без постоянного подкручивания и напряжения пресса.",
        ["Сними профиль в обычной стойке.", "Проверь подвижность тазобедренных и дыхание рёбрами.", "Добавь контроль таза в мосте и dead bug.", "Сохраняй нейтраль во время ходьбы и упражнений, а не только у стены."],
        ["Считать любой прогиб патологией.", "Держать пресс втянутым весь день.", "Растягивать поясницу через боль."],
        "Стоять и двигаться легче, без постоянного зажима ягодиц или поясницы.",
        "Боль с отдачей в ногу, онемение или нарушение функций требуют медицинской оценки."
    ),
    "Походка": guideKnowledgeItem(
        "Более спокойная, уверенная походка без искусственной «модельной» постановки.",
        ["Сними 10 шагов спереди, сбоку и сзади.", "Смотри на длину шага, движение рук и направление стоп.", "Практикуй мягкое перекатывание и взгляд вперёд.", "Сохраняй естественный ритм, постепенно добавляя скорость."],
        ["Насильно разворачивать стопы прямо.", "Делать слишком длинный шаг.", "Фиксировать плечи и таз ради «идеальной» линии."],
        "Шаги симметричны по ритму, руки двигаются свободно, голова не подпрыгивает.",
        "Хромота, боль или внезапное изменение походки требуют специалиста."
    ),
    "Фото осанки": guideKnowledgeItem(
        "Получать сравнимые снимки, по которым можно видеть тенденцию, а не случайную позу.",
        ["Поставь камеру на уровне середины корпуса и отойди на 2–3 метра.", "Используй один фон, свет и положение стоп.", "Сними анфас, профиль и спину в расслабленном состоянии.", "Повторяй серию раз в 2–4 недели."],
        ["Подтягиваться специально перед каждым фото.", "Снимать на широкоугольную камеру вблизи.", "Сравнивать разную обувь и высоту камеры."],
        "Линии уха, плеч, таза и колена видны без перспективного искажения.",
        "Фото не заменяет диагностику боли или структурных нарушений."
    ),
    "Ежедневный комплекс": guideKnowledgeItem(
        "Короткая последовательность для подвижности и контроля, которую реально повторять.",
        ["Начни с 1 минуты спокойного дыхания.", "Добавь движение грудного отдела и мягкое втягивание подбородка.", "Сделай скольжения руками у стены и ягодичный мост.", "Заверши минутой ходьбы с новым ощущением положения тела."],
        ["Собирать комплекс из десятков упражнений.", "Делать одинаковую нагрузку при боли и без боли.", "Ждать изменения осанки без корректировки рабочего места."],
        "Комплекс занимает 8–10 минут и после него движения ощущаются свободнее.",
        "Любое упражнение, вызывающее резкую боль, онемение или головокружение, нужно исключить."
    ),
    "Свет": guideKnowledgeItem(
        "Мягкий объём лица без плоской вспышки и глубоких теней под глазами.",
        ["Встань в метре от окна под углом 30–45 градусов.", "Выключи верхний жёсткий свет.", "Поверни лицо на несколько градусов и наблюдай за тенями.", "Зафиксируй экспозицию по коже, не по фону."],
        ["Снимать лицом к прямому солнцу.", "Смешивать холодный свет окна и тёплые лампы.", "Поднимать экспозицию до потери текстуры кожи."],
        "Глаза читаются, нос и челюсть имеют объём, а светлые участки не выбиты.",
        "Для повторных анализов используй нейтральный свет без цветных фильтров."
    ),
    "Ракурс": guideKnowledgeItem(
        "Найти высоту и поворот камеры, которые сохраняют реальные пропорции лица.",
        ["Поставь камеру примерно на уровне глаз.", "Отойди дальше и используй умеренное приближение вместо широкого угла вблизи.", "Сделай серии прямо, 3/4 и профиль.", "Сравни уши, нос и челюсть на отсутствие перспективного растяжения."],
        ["Снимать снизу на фронтальную камеру в упор.", "Сильно вытягивать шею к объективу.", "Оценивать лицо по одному случайному кадру."],
        "Лицо похоже на себя в зеркале, а нос и лоб не выглядят непропорционально крупными.",
        "Для анализа внешности важнее нейтральный документальный ракурс, чем самый выигрышный."
    ),
    "Выражение": guideKnowledgeItem(
        "Живое и уверенное лицо без зажатой челюсти и искусственной улыбки.",
        ["Сделай длинный выдох перед кадром.", "Расслабь язык, лоб и плечи.", "Смотри в объектив как на знакомого человека.", "Сними серии с нейтральным лицом, лёгкой улыбкой и открытой улыбкой."],
        ["Зажимать губы ради контура.", "Поднимать брови на каждом кадре.", "Удерживать улыбку слишком долго."],
        "Глаза и рот передают одно настроение, а лицо не выглядит неподвижной маской.",
        "Нейтральное выражение нужно для анализа; эмоциональное — для профиля."
    ),
    "Аватарка": guideKnowledgeItem(
        "Кадр, который остаётся узнаваемым в маленьком круге интерфейса.",
        ["Сними лицо крупно с запасом под круглый кроп.", "Используй простой контрастный фон.", "Выбери свет, отделяющий волосы и плечи от фона.", "Проверь результат в размере 40–60 пикселей."],
        ["Ставить групповой снимок.", "Оставлять много пустого пространства над головой.", "Использовать мелкие детали, которые исчезают в миниатюре."],
        "В маленьком размере сразу читаются лицо, взгляд и силуэт головы.",
        "Не публикуй кадр с геометкой или деталями, раскрывающими лишнюю личную информацию."
    ),
    "Фото для знакомств": guideKnowledgeItem(
        "Серия, которая показывает лицо, рост, стиль и реальную жизнь без постановочного шума.",
        ["Первым поставь ясный портрет без очков.", "Добавь фото в полный рост и один социальный контекст.", "Покажи занятие, которое действительно повторяется в твоей жизни.", "Сохрани единый актуальный образ по возрасту, волосам и форме."],
        ["Повторять один ракурс на всех фото.", "Использовать старые или сильно обработанные снимки.", "Открывать профиль кадром из далёкой группы."],
        "Каждое фото сообщает новую информацию, а человек остаётся узнаваемым во всей серии.",
        "Не включай в кадры чужих детей и людей без их согласия."
    ),
    "Разбор серии": guideKnowledgeItem(
        "Отобрать сильные кадры по функции, а не по бесконечному увеличению недостатков.",
        ["Раздели фото на портрет, полный рост, действие и социальный контекст.", "Сначала удали технический брак.", "Выбери по одному лучшему кадру каждой функции.", "Покажи финальную серию двум людям и спроси, какое впечатление она создаёт."],
        ["Оставлять десять почти одинаковых селфи.", "Выбирать только по резкости кожи.", "Смешивать кадры с радикально разной обработкой."],
        "Серия разнообразна, последовательна и передаёт тот образ, который ты хотел.",
        "Если отбор усиливает навязчивую фиксацию на внешности, сделай паузу и ограничь время просмотра."
    ),
    "Жевательные мышцы: трезвый подход": guideKnowledgeItem(
        "Не навредить суставу и зубам ради сомнительных обещаний «расширить челюсть».",
        ["Оцени нижнюю треть без напряжения и с обычной позой головы.", "Если есть щелчки, боль или стираемость зубов, начни со стоматолога.", "Для визуального контура работай со сном, общей формой тела, светом и бородой.", "Любую лечебную нагрузку на жевательные мышцы согласовывай со специалистом."],
        ["Жевать экстремально твёрдые предметы.", "Тренироваться через боль и щелчки.", "Пытаться изменить костную структуру упражнениями во взрослом возрасте."],
        "Главный критерий — отсутствие боли и нормальная функция, а не усталость мышц после тренировки.",
        "Блокировка челюсти, ограничение открытия рта или боль требуют стоматолога или специалиста по ВНЧС."
    ),
    "Брекеты и элайнеры": guideKnowledgeItem(
        "Сравнить методы коррекции по диагнозу, дисциплине и образу жизни, а не по рекламе.",
        ["Собери диагностику и список целей лечения.", "Уточни, какие перемещения нужны и подходят ли для них элайнеры.", "Спроси про сроки, ретенцию, гигиену и действия при поломке.", "Получай план и стоимость письменно, включая дополнительные этапы."],
        ["Выбирать систему без полноценной диагностики.", "Считать элайнеры автоматически быстрее и незаметнее.", "Игнорировать пожизненную важность ретенции."],
        "Ты понимаешь цель каждого этапа, ограничения метода и полный бюджет лечения.",
        "Ортодонтическое лечение должен планировать лицензированный специалист после очной диагностики."
    ),
    "Консультация ортодонта": guideKnowledgeItem(
        "Выйти с консультации с понятным диагнозом, вариантами и критериями выбора.",
        ["Возьми предыдущие снимки и список жалоб.", "Спроси, что является медицинской задачей, а что эстетической.", "Попроси показать альтернативы, риски и влияние на профиль.", "Уточни необходимость удалений, междисциплинарных консультаций и ретейнеров."],
        ["Соглашаться на план, который не можешь пересказать.", "Оценивать врача только по обещанному сроку.", "Скрывать симптомы ВНЧС или проблемы с дёснами."],
        "После встречи у тебя есть письменный план, обследования и время на решение без давления.",
        "Для сложного плана разумно получить независимое второе мнение."
    ),
    "Прикус и профиль": guideKnowledgeItem(
        "Понять, какие черты профиля связаны с положением зубов, а какие — со скелетными пропорциями.",
        ["Сделай нейтральное фото профиля без вытягивания шеи.", "Запиши функциональные жалобы: жевание, речь, дыхание, сустав.", "Пройди диагностику у ортодонта, если проблема стойкая.", "Обсуди, что реально изменит ортодонтия, а что требует другой специальности."],
        ["Диагностировать прикус по селфи.", "Ожидать, что брекеты всегда радикально изменят челюсть.", "Игнорировать функцию ради одной линии профиля."],
        "Решение основано на диагностике и функции, а ожидаемые изменения профиля проговорены заранее.",
        "Боль, травма зубов или нарушение жевания требуют очной стоматологической оценки."
    ),
    "Когда идти к специалисту": guideKnowledgeItem(
        "Отличить эстетическое любопытство от симптомов, которые действительно требуют диагностики.",
        ["Запиши боль, щелчки, стираемость, трудности жевания и дыхания.", "Отметь длительность и влияние на сон или питание.", "Начни со стоматолога или ортодонта, который направит дальше.", "Возьми список лекарств, снимки и историю лечения."],
        ["Ждать усиления боли ради более очевидного диагноза.", "Лечить прикус капами из интернета.", "Считать отсутствие идеальной симметрии заболеванием."],
        "Консультация нужна, если симптом повторяется, мешает функции или прогрессирует.",
        "Острая травма, сильная боль, отёк или невозможность открыть рот требуют срочной помощи."
    ),
    "Ринопластика": guideKnowledgeItem(
        "Оценить изменение носа в контексте дыхания, лица, рисков и длительного восстановления.",
        ["Сформулируй отдельно функциональные и эстетические цели.", "Ищи сертифицированного хирурга с опытом нужного типа операции.", "Обсуди дыхание, толщину кожи, ограничения моделирования и ревизии.", "Спроси про этапы отёка и когда оценивается финальный результат."],
        ["Выбирать хирурга по одному идеальному кейсу.", "Требовать нос конкретного человека.", "Планировать важное событие слишком близко к операции."],
        "Ожидания описаны конкретно, а хирург объяснил, что возможно и что нет.",
        "Это необратимое медицинское решение; нужны очная диагностика, информированное согласие и время на размышление."
    ),
    "Блефаропластика": guideKnowledgeItem(
        "Понять, связана ли зона век с кожей, жировыми пакетами, бровями или качеством сна.",
        ["Сделай фото утром и вечером без поднятых бровей.", "Пройди оценку зрения, сухости глаз и положения век.", "Обсуди с хирургом риск изменения формы глаза и рубцов.", "Уточни уход, ограничения и сроки возвращения к линзам и нагрузкам."],
        ["Диагностировать избыток кожи по фото с напряжённым лбом.", "Игнорировать сухость глаз.", "Ожидать, что операция уберёт тёмные круги любой причины."],
        "Хирург связал предложенную технику с твоей анатомией и объяснил альтернативы.",
        "Проблемы зрения и заболевания глаз нужно сначала обсудить с офтальмологом."
    ),
    "Подбородок": guideKnowledgeItem(
        "Разобрать проекцию подбородка вместе с прикусом, шеей и пропорциями средней трети.",
        ["Сделай нейтральные анфас и профиль без выдвижения челюсти.", "Сначала исключи ортодонтическую или скелетную причину.", "Сравни имплант, костную коррекцию и отказ от вмешательства.", "Обсуди чувствительность, асимметрию и влияние на губы."],
        ["Оценивать подбородок отдельно от прикуса.", "Принимать решение по одному фильтрованному профилю.", "Считать филлер полноценной диагностической пробой без рисков."],
        "Выбранный метод соответствует причине, а не просто маскирует её на одном ракурсе.",
        "Нужна очная консультация профильного хирурга и при необходимости ортодонта."
    ),
    "Скулы": guideKnowledgeItem(
        "Понять, нужен ли объём скул или впечатление создают свет, жировые пакеты и общая композиция лица.",
        ["Сними лицо при мягком и боковом свете.", "Оцени среднюю треть вместе с висками и нижней челюстью.", "Обсуди обратимые и необратимые варианты и их пределы.", "Спроси о смещении, асимметрии и изменении мимики."],
        ["Выбирать максимальную проекцию по 3D-фильтру.", "Игнорировать асимметрию исходной кости.", "Комбинировать несколько вмешательств без общей цели."],
        "Предложенное изменение выглядит естественно в анфас, 3/4 и профиль.",
        "Любое инвазивное вмешательство требует квалифицированного врача и понимания осложнений."
    ),
    "Липосакция лица": guideKnowledgeItem(
        "Оценить, действительно ли объём связан с локальной жировой тканью, а не с отёком или анатомией.",
        ["Сравни лицо утром и вечером, при стабильном весе.", "Обсуди качество кожи и риск неровностей.", "Уточни точную зону, объём и способ контроля симметрии.", "Спроси, что произойдёт при дальнейшем снижении веса и с возрастом."],
        ["Пытаться убрать естественную полноту молодого лица.", "Игнорировать отёки и колебания веса.", "Ожидать, что процедура изменит костные пропорции."],
        "Показания подтверждены очной оценкой, а ожидаемый эффект ограничен реальной зоной.",
        "Удалённый объём трудно вернуть; решение требует особенно консервативного подхода."
    ),
    "Риски операций": guideKnowledgeItem(
        "Перевести абстрактное «осложнения бывают редко» в конкретный личный риск‑профиль.",
        ["Попроси назвать частые, серьёзные и специфические осложнения.", "Уточни квалификацию команды и аккредитацию клиники.", "Спроси, кто доступен ночью и что считается экстренной ситуацией.", "Получай план коррекции неудовлетворительного результата до операции."],
        ["Считать фотографии «до/после» доказательством безопасности.", "Скрывать курение, лекарства и заболевания.", "Подписывать согласие в день первой консультации под давлением."],
        "Ты можешь своими словами объяснить риски, альтернативы и план действий при осложнении.",
        "Если ответы уклончивы или тебя торопят, остановись и получи независимое мнение."
    ),
    "Как готовить вопросы врачу": guideKnowledgeItem(
        "Провести консультацию как сбор данных, а не как продажу мечты.",
        ["Запиши три главные цели и три опасения.", "Спроси о квалификации, частоте процедуры и типичных осложнениях.", "Попроси показать похожие исходные случаи без фильтров.", "Уточни восстановление, помощь дома, полную стоимость и политику ревизий."],
        ["Показывать только картинки желаемого результата.", "Забывать спросить об альтернативах без операции.", "Принимать решение до того, как эмоции после консультации улягутся."],
        "После консультации есть письменные ответы, реалистичный диапазон результата и пауза на решение.",
        "Хороший специалист спокойно обсуждает ограничения и не гарантирует идеальный результат."
    ),
    "Подбородочный имплант": guideKnowledgeItem(
        "Сравнить постоянный имплант с костной коррекцией и понять влияние на профиль и мягкие ткани.",
        ["Сначала оцени прикус и костные пропорции.", "Обсуди форму, размер, способ фиксации и расположение разреза.", "Спроси о риске смещения, инфекции, онемения и влиянии на кость.", "Посмотри симуляцию консервативного и более выраженного вариантов."],
        ["Выбирать размер только по боковому профилю.", "Игнорировать ширину подбородка анфас.", "Считать имплант легко обратимым без последствий."],
        "Имплант согласован с анфасом, профилем и функцией прикуса.",
        "Нужен хирург с профильным опытом и понятным планом наблюдения."
    ),
    "Скуловые импланты": guideKnowledgeItem(
        "Оценить постоянное увеличение средней трети без потери естественной мимики.",
        ["Разбери дефицит проекции отдельно в передней и боковой части скулы.", "Обсуди анатомическую форму, фиксацию и доступ.", "Спроси о симметрии, чувствительности, инфекции и ревизии.", "Проверь предполагаемый эффект во всех ключевых ракурсах."],
        ["Выбирать имплант только ради более резкой тени.", "Игнорировать виски и подглазничную область.", "Сочетать имплант с другими изменениями без общего плана."],
        "Ожидаемый объём поддерживает лицо, но не доминирует над глазами и челюстью.",
        "Решение необратимое и требует сертифицированного хирурга и второго мнения при сомнениях."
    ),
    "Набор массы": guideKnowledgeItem(
        "Добавлять мышцы с контролируемым профицитом, а не просто увеличивать вес.",
        ["Определи поддерживающую калорийность по двум неделям наблюдений.", "Добавь небольшой профицит и держи достаточный белок.", "Строй программу вокруг прогрессии базовых движений.", "Контролируй средний вес, талию и силовые раз в неделю."],
        ["Удваивать калории ради скорости.", "Менять программу каждую неделю.", "Оценивать набор только по весам без талии и фото."],
        "Силовые растут, вес прибавляется постепенно, а талия не ускоряется непропорционально.",
        "При заболеваниях, значительном дефиците веса или расстройствах питания нужен специалист."
    ),
    "Похудение": guideKnowledgeItem(
        "Снижать жир с сохранением мышц, энергии и адекватного отношения к еде.",
        ["Создай умеренный дефицит, который можно держать неделями.", "Сохраняй белок, силовые тренировки и ежедневную активность.", "Смотри на среднюю массу за неделю, а не на один день.", "Корректируй калории только после 2–3 недель плато."],
        ["Резко убирать углеводы и соль перед каждым взвешиванием.", "Компенсировать переедание голодом и избыточным кардио.", "Оценивать прогресс только по лицу."],
        "Вес и талия снижаются постепенно, а рабочие веса и самочувствие в основном сохраняются.",
        "Головокружение, нарушения цикла, приступы переедания или чрезмерная фиксация требуют помощи специалиста."
    ),
    "Рекомпозиция": guideKnowledgeItem(
        "Одновременно улучшать соотношение мышц и жира при стабильном весе.",
        ["Держи калории около поддержки и достаточный белок.", "Тренируй каждую крупную мышечную группу с измеримой прогрессией.", "Фиксируй талию, фото и силовые раз в 2–4 недели.", "При отсутствии прогресса корректируй сон, объём и точность рациона."],
        ["Ждать быстрых изменений на весах.", "Тренироваться без прогрессии нагрузки.", "Ежедневно менять калории по зеркалу."],
        "При похожем весе талия уменьшается, форма становится плотнее, силовые растут.",
        "Рекомпозиция медленнее отдельного набора или снижения веса — это нормальный компромисс."
    ),
    "Плечи и спина": guideKnowledgeItem(
        "Создать более выраженный верх силуэта через ширину, толщину и осанку.",
        ["Сочетай вертикальные и горизонтальные тяги.", "Добавь подъёмы на среднюю и заднюю дельту.", "Веди журнал повторов и рабочих весов.", "Снимай технику, чтобы не заменять движение плечами и поясницей."],
        ["Тренировать только широчайшие одним упражнением.", "Пожимать плечами во всех подъёмах.", "Игнорировать боль ради визуальной ширины."],
        "Растут повторения или вес, а линия плеч и спины заметно меняется на фото за 8–12 недель.",
        "Острая боль или потеря силы требуют остановки упражнения и оценки специалиста."
    ),
    "Талия и пресс": guideKnowledgeItem(
        "Улучшить композицию талии через общий процент жира, мышечный контроль и грамотные ракурсы.",
        ["Оцени среднюю талию утром раз в неделю.", "Тренируй сгибание, антиразгибание и боковую стабильность корпуса.", "Настрой питание под цель веса.", "Работай с дыханием и положением рёбер без постоянного втягивания живота."],
        ["Делать сотни скручиваний ради локального жиросжигания.", "Обезвоживаться перед фото.", "Держать вакуум и напряжение пресса весь день."],
        "Талия и фото меняются вместе с силой корпуса и общей композицией тела.",
        "Боль, грыжа или выраженные нарушения пищевого поведения требуют специалиста."
    )
};

function guideKnowledgeItem(goal, actions, mistakes, checkpoint, caution) {
    return { goal, actions, mistakes, checkpoint, caution };
}
...
function renderGuideDetail(guide) {
    return `<section class="section-panel guide-detail">
        ...
        <h1>${guide.title}</h1>
        <p class="muted">${guide.intro}</p>
        <div class="guide-fact-strip">
            <span><small>Формат</small><strong>${escapeHtml(guide.format)}</strong></span>
            <span><small>Действия</small><strong>${guide.actionCount}</strong></span>
            <span><small>Контроль</small><strong>${escapeHtml(guide.controlLabel)}</strong></span>
        </div>
        <div class="guide-section-list">${guide.sections.map(section => `<article class="guide-section">
            <span class="guide-section-index">${String(section.index).padStart(2, "0")}</span>
...
function guideProtocol(guide) {
    return `<article class="guide-section guide-protocol">
        <span class="guide-section-index">✓</span>
        <h2>Критерий результата</h2>
        <p>${escapeHtml(guide.checkpoint)}</p>
        <ul class="guide-list">
            <li>${escapeHtml(guide.controlAction)}</li>
            <li>${escapeHtml(guide.caution)}</li>
        </ul>
        <div class="guide-control-card">
            <span class="icon-shell"><i data-lucide="bookmark-check"></i></span>
            <div>
                <p class="eyebrow">${guide.categoryTrack === "hard" ? "Решение без спешки" : "Следующий шаг"}</p>
                <h3>${escapeHtml(guide.title)}</h3>
                <p class="muted">${escapeHtml(guide.routeAction)}</p>
            </div>
        </div>
    </article>`;
}
...
function makeGuide(category, title, index) {
    ...
    const knowledge = guideKnowledge[title] || fallbackGuideKnowledge(category, title);
    return {
        id,
        ...
        tag: category.tag,
        title,
        intro: knowledge.goal,
        likes: 1 + (index % 7),
        sections: guideSectionsFor(category, title, knowledge),
        checkpoint: knowledge.checkpoint,
        caution: knowledge.caution,
        controlAction: guideControlAction(category, title),
        routeAction: knowledge.actions[0],
        format: guideFormat(category, title),
        actionCount: knowledge.actions.length,
        controlLabel: guideControlLabel(category)
    };
}
...
function guideSectionsFor(category, title, knowledge) {
    const frame = guideSectionFrame(category);
    const splitAt = Math.max(2, Math.ceil(knowledge.actions.length / 2));
    const firstActions = knowledge.actions.slice(0, splitAt);
    const nextActions = knowledge.actions.slice(splitAt);
    return [
        {
            index: 1,
            title: frame[0],
            text: guideContextText(category, title, knowledge.goal),
            items: firstActions
        },
        {
            index: 2,
            title: frame[1],
            text: guidePracticeText(category, title),
            items: nextActions.length ? nextActions : [knowledge.checkpoint]
        },
        {
            index: 3,
            title: frame[2],
            text: guideMistakeText(category, title),
            items: knowledge.mistakes
        }
    ];
}

function guideSectionFrame(category) {
    return {
        skin: ["Сначала разберись с кожей", "Схема применения", "Что перегружает барьер"],
        hair: ["Задача формы", "Техника дома или у мастера", "Из-за чего форма разваливается"],
        brows: ["Как меняется взгляд", "Точная коррекция", "Где легко переборщить"],
        style: ["Пропорции образа", "Сборка на практике", "Что создаёт визуальный шум"],
        posture: ["Исходное движение", "Практика без боли", "Компенсации и ошибки"],
        photo: ["Что должен решить кадр", "Настройка съёмки", "Что искажает результат"],
        body: ["Цель и исходные данные", "План прогрессии", "Что тормозит результат"],
        jaw: ["Функция раньше эстетики", "Безопасный план", "Опасные обещания"],
        ortho: ["Диагноз и варианты", "Вопросы на консультации", "Красные флаги"],
        bite: ["Функция и профиль", "Маршрут диагностики", "Чего не видно на селфи"],
        operations: ["Показания и ожидания", "Разговор с хирургом", "Риски решения"],
        implants: ["Пропорции и анатомия", "Планирование вмешательства", "Необратимые компромиссы"]
    }[category.id] || ["Исходная точка", "Практический план", "Ошибки"];
}

function guideContextText(category, title, goal) {
    if (category.track === "hard") {
        return `${title} — тема для диагностики и спокойного решения. Цель этого материала: ${goal.toLowerCase()}`;
    }
    return `${title} стоит оценивать по конкретной визуальной или функциональной задаче. Здесь цель такая: ${goal.toLowerCase()}`;
}

function guidePracticeText(category, title) {
    if (category.id === "photo") return `Собери условия заранее и меняй по одному параметру. Так станет ясно, что именно улучшило кадр «${title}».`;
    if (category.id === "body") return `Фиксируй питание, нагрузку и восстановление как одну систему — для темы «${title}» отдельный удачный день ничего не доказывает.`;
    if (category.track === "hard") return `Не принимай решение по симуляции или одному мнению. Для темы «${title}» важны диагностика, альтернативы и понятный план восстановления.`;
    return `Выполняй действия по порядку и оценивай результат в одинаковых условиях. Для темы «${title}» это важнее количества новых средств и техник.`;
}

function guideMistakeText(category, title) {
    if (category.track === "hard") return `Эти ошибки особенно опасны в теме «${title}», потому что цена поспешного решения может быть необратимой.`;
    return `Ниже — ошибки, которые чаще всего мешают получить понятный результат в теме «${title}».`;
}

function guideControlAction(category, title) {
    if (category.id === "photo") return "Сохрани исходный и итоговый кадр без фильтров с одинаковым кропом.";
    if (category.id === "body") return "Сравни средние показатели за 2–4 недели: фото, талию, вес и силовые.";
    if (category.id === "posture") return "Повтори фото и короткое видео движения в тех же условиях через 2–4 недели.";
    if (category.track === "hard") return "Запиши варианты, риски и вопросы; не принимай решение в день консультации.";
    return "Сделай контрольное фото или заметку в одинаковых условиях и сравни не раньше указанного срока.";
}

function guideControlLabel(category) {
    if (category.id === "body") return "2–4 недели";
    if (category.id === "photo") return "серия кадров";
    if (category.track === "hard") return "консультация";
    return "фото до/после";
}

function guideFormat(category, title) {
    if (category.id === "operations" || category.id === "implants") return "чеклист решения";
    if (["ortho", "bite", "jaw"].includes(category.id)) return "диагностика";
    if (category.id === "body") return "план прогрессии";
    if (category.id === "photo") return "практикум";
    if (title.includes("протокол") || title.includes("комплекс")) return "пошагово";
    return "практический гайд";
}

function fallbackGuideKnowledge(category, title) {
    return guideKnowledgeItem(
        `${title}: конкретная задача, которую можно проверить в одинаковых условиях.`,
        ["Зафиксируй исходную точку.", "Измени один параметр.", "Повтори действие несколько раз.", "Сравни результат."],
        ["Менять всё одновременно.", "Оценивать по одному случайному дню.", "Игнорировать дискомфорт."],
        "Результат заметен на сопоставимом фото или замере.",
        category.track === "hard" ? "Необратимые решения обсуждай с квалифицированным специалистом." : "При боли или стойком раздражении остановись."
    );
}
